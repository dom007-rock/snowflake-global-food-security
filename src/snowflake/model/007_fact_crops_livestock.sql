...
--   value
--
-- Unit remains on the fact because measurement units depend on the
-- observation/element and should not be assumed solely from the dimension.
-- =============================================================================


CREATE TABLE IF NOT EXISTS FACT_CROPS_LIVESTOCK (
...
USING (
    ...
    FROM GFS_DEV.CLEAN.FAOSTAT_QCL q
